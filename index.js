...
class Instructor extends Lambdasian {
  constructor(name,age,location,speciality,favLang,catchPhrase){
    super({name,age,location,speciality,favLang,catchPhrase});
...
*/
 class Student extends Lambdasian {
    constructor({name,age,location,previousBackround,className,favSub}){
    super({name,age,location,previousBackround,className,favSub});
    this.previousBackround=previousBackround;
    this.className=className;
    this.favSubject=this.favSubject;
    }
...
class ProjectManager extends Instructor {
  constructor({name,age,location,speciality,favLang,catchPhrase,gradClassName,favInstructor}){
  super({name,age,location,speciality,favLang,catchPhrase,gradClassName,favInstructor});
